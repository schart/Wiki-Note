...
import * as utils from '../../utils/util.postgresql.config';
...
export class DB 
{
    ...
    init_note = () => {
        ...
        let Note_info: Promise<QueryResult<any>> = utils.posgres_client.query(` 
        ...
        const Note_title: Promise<QueryResult<any>> = utils.posgres_client.query(`
        ...
        const Note_url: Promise<QueryResult<any>> = utils.posgres_client.query
        (`
        ...
        const Note_file: Promise<QueryResult<any>> = utils.posgres_client.query
        (`
        ...
        const Note_comment: Promise<QueryResult<any>> = utils.posgres_client.query
        (`
        ...
        const Note_like: Promise<QueryResult<any>> = utils.posgres_client.query
        (`
        ...
        const Note_reported: Promise<QueryResult<any>> = utils.posgres_client.query
        (`
    ...
    init_follow =  () => 
    {
        ...
        const Follow: Promise<QueryResult<any>> = utils.posgres_client.query
            (`
    ...
    init_notification =  () => 
    {
        const Notification: Promise<QueryResult<any>> = utils.posgres_client.query
        (`
    ...
    init_readAtLater = () => 
    {
        const ReadAtLater: Promise<QueryResult<any>> = utils.posgres_client.query
        (`
