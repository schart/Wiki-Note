...
NoteRoute.post("/delete/", user_midwares.requireAuth, note_midwares.presenceNote, /* That proccess endpoint for admin */ Note_C.note_delete, (req: Request, res: Response, next: NextFunction) => { })
NoteRoute.post("/accept/", user_midwares.requireAuth, note_midwares.presenceNote, /* That proccess endpoint for admin */ Note_C.note_accept, (req: Request, res: Response, next: NextFunction) => { })
